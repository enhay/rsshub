...
router.get('/juejin/main', require('./routes/juejin/main'));
...
router.get('/wechat/sogou/:wd', require('./routes/tencent/wechat/sogou'));
...
// pgc网站聚合
router.get('/pgc/websites', require('./routes/pgc_websites'));
// pgc论坛聚合
router.get('/pgc/bbs', require('./routes/pgc_bbs'));
